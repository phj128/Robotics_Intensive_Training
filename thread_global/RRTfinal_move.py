...
class RRT:
    ...
    def __init__(self, start_x, start_y, goal_x, goal_y, infos, step=10, robot_id=0, color='blue',
        ...
        self.Update_barrier_radius(robot_id, color)

    def Update_barrier_radius(self, robot_id, color):
        self.barrierInfo = [[info[0] + 0.02*info[5]*cos(info[7]), info[1]+0.02*info[5]*sin(info[7]), info[2], info[3]] for info in self.barrierInfo]
